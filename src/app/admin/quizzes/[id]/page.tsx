                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-2">
                          <div className="flex-1">
                            ...
                            {(question.imageBase64 || (question.images && question.images.length > 0)) && (
                              <div className="mt-2 border rounded-lg p-2 bg-white inline-block">
                                <img 
                                  src={question.imageBase64 || (question.images && question.images[0]?.downloadUrl)} 
                                  alt={question.images?.[0]?.altText || 'Question image'} 
                                  className="rounded"
            ...
            <div className="space-y-4 py-4">
              ...
              <div>
                ...
                {editingQuestion.images && editingQuestion.images.length > 0 && !editingQuestion.imageBase64 ? (
                  <ImagePreview
                    imageUrl={editingQuestion.images[0].downloadUrl}
